...
import { ArrowLeftIcon, PencilIcon, TruckIcon, ShoppingCartIcon, BanknotesIcon, ArrowRightIcon, ClockIcon } from "@heroicons/react/24/outline"
  ...
  if (!supplier) {
    return (
      <div className="min-h-screen bg-abyssal-bg flex flex-col items-center justify-center gap-3 p-4">
        <TruckIcon className="w-12 h-12 text-abyssal-red" />
          ...
          <div className="animate-fade-in">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-title-medium text-abyssal-text-primary flex items-center gap-2">
                <ShoppingCartIcon className="w-4 h-4 text-abyssal-text-secondary" />
            ...
            {purchases.length === 0 ? (
              <Card className="p-6 text-center">
                <ShoppingCartIcon size={40} className="text-abyssal-text-secondary mx-auto mb-2" strokeWidth={1} />
