      ...
      <form onSubmit={handleSubmit} className="p-4 space-y-4 max-w-[480px] mx-auto">
        ...
        <div className="space-y-1.5">
          ...
          <select value={form.category} onChange={(e) => setForm({ ...form, category: e.target.value })}
            className="w-full bg-abyssal-surface-high rounded-abyssal-sm px-4 py-3 text-body-medium text-abyssal-text-primary outline-none border border-abyssal-primary/20 focus:border-abyssal-primary focus:ring-2 focus:ring-abyssal-primary/20 transition-all appearance-none">
        ...
        <div className="space-y-1.5">
          ...
          <textarea value={form.description} onChange={(e) => setForm({ ...form, description: e.target.value })}
            className="w-full bg-abyssal-surface-high rounded-abyssal-sm px-4 py-3 text-body-medium text-abyssal-text-primary outline-none border border-abyssal-primary/20 focus:border-abyssal-primary focus:ring-2 focus:ring-abyssal-primary/20 transition-all min-h-[80px] resize-none" />
        </div>
        <div className="space-y-1.5">
        ...
        <label className="flex items-center gap-3 py-2 cursor-pointer">
          <div className={cn(
            ...
            form.is_extra_quality ? "bg-abyssal-primary border-abyssal-primary" : "border-abyssal-primary/20"
          )}>
