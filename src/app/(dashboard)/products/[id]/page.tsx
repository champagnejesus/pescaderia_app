...
export default function ProductDetailPage() {
  ...
  const priceHistory = DAYS.map((day) => ({
    day,
    price: Math.max(0, product.price_venta * (0.85 + Math.random() * 0.3)),
  }))
          ...
          <div className="grid grid-cols-3 gap-3 animate-fade-in" style={{ animationDelay: "100ms" }}>
            <div className="bg-abyssal-surface rounded-abyssal-md p-4">
              ...
              <p className="text-headline-medium text-abyssal-text-primary font-bold mt-1">
                ${product.price_compra.toLocaleString("es-MX", { minimumFractionDigits: 2 })}
              </p>
            </div>
            <div className="bg-abyssal-surface rounded-abyssal-md p-4">
              <p className="text-label-medium text-abyssal-text-secondary">P. Venta</p>
              <p className="text-headline-medium text-abyssal-text-primary font-bold mt-1">
                ${product.price_venta.toLocaleString("es-MX", { minimumFractionDigits: 2 })}
              </p>
            </div>
            <div className="bg-abyssal-surface rounded-abyssal-md p-4">
