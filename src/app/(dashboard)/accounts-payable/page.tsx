      ...
      <div className="p-4 space-y-3">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-title-medium text-abyssal-text-primary mb-2">No hay cuentas por pagar</p>
            <p className="text-body-medium text-abyssal-text-secondary">Todos los proveedores están al corriente</p>
          </div>
        ) : (
          debtors.map((debtor) => (
