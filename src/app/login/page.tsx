  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden">
      <div className="w-full max-w-sm flex flex-col items-center gap-5 relative z-10">
        ...
        <p className="text-[11px] font-semibold tracking-wide uppercase text-abyssal-text-secondary bg-abyssal-surface-high/50 border border-abyssal-outline rounded-full px-4 py-1.5">
          Abyssal ERP v1.0
        </p>
      </div>
    </div>
