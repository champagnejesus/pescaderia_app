...
export function CheckoutSummary({ items, paymentMethod, paymentStatus, onSubmit, loading }: CheckoutSummaryProps) {
  ...
  return (
    <div className="bg-abyssal-surface rounded-abyssal-sm p-4 space-y-3">
      ...
      <div className="border-t border-abyssal-primary/20 pt-2 space-y-1">
      ...
      <div className="flex items-center justify-between pt-1 border-t border-abyssal-primary/20">
