...
async def migrate(conn):
    ...
    col_migrations = [
        ...
        ("products", "updated_at", f"{datetime_type} DEFAULT '1970-01-01 00:00:00'"),
        ...
        ("clients", "updated_at", f"{datetime_type} DEFAULT '1970-01-01 00:00:00'"),
        ("suppliers", "updated_at", f"{datetime_type} DEFAULT '1970-01-01 00:00:00'"),
