...
def upgrade() -> None:
    ...
    if 'business_config' in existing_tables:
        # Tables exist, but they might be in an old schema version (missing business_id).
        # Let's dynamically add 'business_id' to any table that exists but is missing it!
        ...
        for table in tables_needing_business_id:
            if table in existing_tables:
                ...
                if 'business_id' not in columns:
                    op.add_column(table, sa.Column('business_id', sa.Integer(), nullable=False, server_default=sa.text('1')))
