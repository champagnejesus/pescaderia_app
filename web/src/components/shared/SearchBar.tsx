  ...
  return (
    <div className={cn("relative group", className)}>
      ...
      <input
        ...
        className="w-full bg-abyssal-surface-high/80 backdrop-blur-sm rounded-2xl px-4 py-3.5 pl-11 pr-11 text-[15px] text-black outline-none border border-abyssal-outline/30 focus:border-abyssal-primary/50 focus:ring-4 focus:ring-abyssal-primary/10 placeholder:text-gray-400 transition-all duration-200"
      />
      {value && (
        <button
          onClick={() => onChange("")}
