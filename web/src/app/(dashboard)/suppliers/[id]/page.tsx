      ...
      <div className="max-w-[480px] mx-auto">
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 animate-fade-in">
            ...
            <div className="bg-abyssal-surface rounded-abyssal-md p-4">
              <p className="text-label-medium text-abyssal-text-secondary">Pago Pendiente</p>
              <p className="text-headline-medium text-abyssal-red font-bold mt-1">
                {formatCurrency(supplier.pending_payment)}
              </p>
            </div>
          </div>

          <div className="bg-abyssal-surface rounded-abyssal-md p-4 animate-fade-in">
            <p className="text-title-medium text-abyssal-text-primary mb-2">Información</p>
            <div className="space-y-2 text-body-medium">
              ...
              <div className="flex justify-between border-t border-abyssal-outline/20 pt-2">
